...
def genarateBar(xp, level):
    ...
    proc = xp / req * 100 # The amount of procent left for the next level
    ...
    draw.rectangle(((0, 16), (600, 25)), fill=TINT_COLOR+(OPACITY,)) # Draw the transparent line under the leveling bar
